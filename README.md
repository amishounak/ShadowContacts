...
| Flavor | Download |
|---|---|
| Full (with Caller ID) | [ShadowContacts-v1.0.2-full.apk](https://github.com/amishounak/ShadowContacts/releases/download/v1.0.2/ShadowContacts-v1.0.2-full.apk) |
| Play Store (no Caller ID) | [ShadowContacts-v1.0.2-playstore.apk](https://github.com/amishounak/ShadowContacts/releases/download/v1.0.2/ShadowContacts-v1.0.2-playstore.apk) |
...
|---|---|---|---|
| `full` | Yes — all telephony permissions | GitHub, F-Droid, sideloading | [ShadowContacts-v1.0.2-full.apk](https://github.com/amishounak/ShadowContacts/releases/download/v1.0.2/ShadowContacts-v1.0.2-full.apk) |
| `playstore` | No — stripped for Play Store compliance | Google Play Store | [ShadowContacts-v1.0.2-playstore.apk](https://github.com/amishounak/ShadowContacts/releases/download/v1.0.2/ShadowContacts-v1.0.2-playstore.apk) |
