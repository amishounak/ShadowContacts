...
**Latest: v1.0.3** — See [CHANGELOG.md](CHANGELOG.md) for version history.

| Flavor | Download |
|---|---|
| Full (with Caller ID) | [ShadowContacts-v1.0.3-full.apk](https://github.com/amishounak/ShadowContacts/releases/download/v1.0.3/ShadowContacts-v1.0.3-full.apk) |
| Play Store (no Caller ID) | [ShadowContacts-v1.0.3-playstore.apk](https://github.com/amishounak/ShadowContacts/releases/download/v1.0.3/ShadowContacts-v1.0.3-playstore.apk) |
| Google Play (closed testing) | [Join the beta](https://play.google.com/apps/testing/com.shadowcontacts.app) |
...
|---|---|---|---|
| `full` | Yes — all telephony permissions | GitHub, F-Droid, sideloading | [ShadowContacts-v1.0.3-full.apk](https://github.com/amishounak/ShadowContacts/releases/download/v1.0.3/ShadowContacts-v1.0.3-full.apk) |
| `playstore` | No — stripped for Play Store compliance | Google Play Store | [ShadowContacts-v1.0.3-playstore.apk](https://github.com/amishounak/ShadowContacts/releases/download/v1.0.3/ShadowContacts-v1.0.3-playstore.apk) |
